firing = table2array(DA2202121748FiringRate);

name = 'DA2202121748FiringRate';
...
[CleanV_pos_pks,CleanV_pos_loc,half_widths,peak_proms] = findpeaks(V_Clean,t,'MinPeakProminence',15,'MinPeakDistance',5);
...
% define threshold 
[dddCleanV,t_diff3,dddCleanV_spike_loc,dddCleanV_1st_spike_p,CleanV_threshold] = FiringRate_thresh_fun(V_Clean,CleanV_pos_loc,t,T);
% threshold
