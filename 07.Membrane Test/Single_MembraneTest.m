Record_current = table2array(MembraneTest);

Name = 'SingleNeuron';

I_Raw = Record_current(:, 1);
...
sample_rate_input = "Please input the sampling rate(Only in put interger and the unit is kHz): \n";
