...
V_RAW = table2array(DA2101040604CCStepDepoAHPV);
...
subplot(5, 1, [1 1])
plot(t,V_Raw)
title('CC_StepDepoAHP','FontSize',fontsize * 1.2,'Interpreter', 'none')
xlim(tlim1)
ylim(vlim1)
legend('0pA','+50pA','+100pA','+150pA')
set(gca,'ytick', vlim1)
...
plot(t, V_Clean)
hold on
title('Clean CC_StepDepoAHP','FontSize',fontsize * 1.2,'Interpreter', 'none')
hold off
xlim(tlim1)
ylim(vlim1)
legend('0pA','+50pA','+100pA','+150pA')
